...
#import "Lesson1AnswerViewController.h"
#import "Lesson1AnswerCell.h"

@interface Lesson1AnswerViewController ()
...
@implementation Lesson1AnswerViewController
...
{
    Lesson1AnswerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell" forIndexPath:indexPath];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 8.0) {
        NSDictionary *data = self.objects[indexPath.row];
        return [Lesson1AnswerCell heightForRowWithTableView:tableView data:data cellIdentifier:@"Cell"];
    } else {
